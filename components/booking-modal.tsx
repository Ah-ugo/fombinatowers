      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-start justify-between">
            <div>
              <DialogTitle className="font-serif text-3xl mb-2">Book Your Space</DialogTitle>
              <DialogDescription className="text-base">
                Complete the form below to proceed with booking {space.name}
              </DialogDescription>
            </div>
        ...
        <div className="border-t border-b border-border py-6 my-6">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold">{formatPrice(space.price)}</div>
              <div className="text-xs text-muted-foreground">per month</div>
            </div>
          </div>
          <p className="text-sm text-muted-foreground">
            A refundable deposit of {formatPrice(space.price * 0.1)} is required to secure your booking.
          </p>
        </div>
          ...
          <div className="bg-muted/50 p-4 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formatPrice(space.price * 0.1)}</span>
              </div>
              <div className="border-t border-border pt-2 mt-2 flex justify-between">
                <span className="font-semibold">Total Due Now</span>
                <span className="font-bold text-lg">{formatPrice(space.price * 0.1)}</span>
              </div>
            </div>
          </div>
