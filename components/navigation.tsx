      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-24">
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            >
              FOMBINA<span className="text-primary group-hover:scale-110 inline-block transition-transform">.</span>
            </div>
          </Link>
              ...
              return (
                <Link
                  ...
                  className={`text-sm font-medium transition-all duration-300 hover:text-primary relative group tracking-wide ${
                    isActive ? "text-primary font-semibold" : isScrolled ? "text-foreground/80" : "text-background/90"
                  }`}
                >
                  {link.label}
                  <span
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-8 border-t border-border bg-background/98 backdrop-blur-xl animate-fade-in">
            <div className="flex flex-col space-y-6">
              ...
              <Button asChild className="bg-primary hover:bg-primary/90 text-primary-foreground w-full shadow-lg">
