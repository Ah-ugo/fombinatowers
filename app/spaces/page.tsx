...
export default function SpacesPage() {
  ...
  const [filter, setFilter] = useState<"all" | "office" | "mall" | "event-hall">("all")
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/modern-office-space-with-city-view.jpg" alt="Spaces Hero" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              ...
              className={filter === "all" ? "bg-primary hover:bg-primary/90 text-primary-foreground shadow-md" : ""}
            >
              All Spaces
            </Button>
            <Button
              ...
              className={filter === "office" ? "bg-primary hover:bg-primary/90 text-primary-foreground shadow-md" : ""}
            >
              Office Spaces
            </Button>
            <Button
              ...
              className={filter === "mall" ? "bg-primary hover:bg-primary/90 text-primary-foreground shadow-md" : ""}
            >
              Mall Spaces
            </Button>
            <Button
              ...
              className={
                filter === "event-hall" ? "bg-primary hover:bg-primary/90 text-primary-foreground shadow-md" : ""
              }
            >
              Event Halls
            </Button>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          {loading ? (
            ...
            <div className="text-center py-16">
              <p className="text-xl text-muted-foreground">No spaces available in this category.</p>
            </div>
          ) : (
              ...
              {filteredSpaces.map((space) => (
                ...
                >
                  <div className="relative aspect-[4/3] overflow-hidden">
                    <img
                      src={space.imageUrl || "/placeholder.svg?height=400&width=600&query=luxury office space"}
                      alt={space.name}
                  ...
                  <CardContent className="p-6">
                    <div className="mb-4">
                      <h3 className="font-serif text-2xl font-semibold mb-2 text-card-foreground">{space.name}</h3>
                      <p className="text-muted-foreground line-clamp-2">{space.description}</p>
                    </div>
                    ...
                    <div className="border-t border-border pt-4 mb-6">
                      <div className="text-sm text-muted-foreground mb-1">Monthly Rate</div>
                      <div className="text-3xl font-bold text-foreground">{formatPrice(space.price)}</div>
                    </div>
                    ...
                    >
                      <Link href={`/spaces/${space._id}`}>
                        {space.available ? "View Details & Book" : "Not Available"}
                      </Link>
                    </Button>
                  </CardContent>
                </Card>
