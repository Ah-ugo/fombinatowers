...
import { Building2, TrendingUp, Shield, Award, ArrowRight, CheckCircle2 } from "lucide-react"
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <video
            ...
            poster="/luxury-skyscraper-at-sunset.jpg"
          >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-12 max-w-2xl mx-auto animate-fade-in leading-relaxed drop-shadow-lg">
            Pre-lease premium office and mall spaces in Nigeria's most prestigious skyscraper development
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slide-in">
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Fombina Tower represents the pinnacle of modern architecture and sustainable development in West Africa.
                Rising majestically in Abuja's Central Business District, this iconic structure will redefine luxury
                commercial real estate.
              </p>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                With world-class amenities, cutting-edge technology, and unparalleled design, Fombina Tower offers an
                exclusive opportunity for forward-thinking businesses and investors to secure their place in history.
              </p>
              <Button
                asChild
                size="lg"
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Secure your space at exclusive pre-construction rates and enjoy unparalleled benefits
            </p>
          </div>
            ...
            {[
              {
                icon: TrendingUp,
                title: "Best Pricing",
                description: "Lock in pre-construction rates up to 30% below market value",
              },
              {
                icon: Building2,
                title: "Prime Location",
                description: "Central Business District with unmatched accessibility",
              },
              {
                icon: Shield,
                title: "Secure Investment",
                description: "Backed by proven developers with international standards",
              },
              {
                icon: Award,
              ...
              >
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="font-serif text-xl font-semibold mb-4 text-card-foreground">{benefit.title}</h3>
      ...
      <section className="py-24 bg-foreground">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-xl mb-12 max-w-2xl mx-auto leading-relaxed text-background/80">
            Join the elite businesses and investors who are shaping Abuja's skyline
          </p>
